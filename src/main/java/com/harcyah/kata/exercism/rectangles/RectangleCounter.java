...
final class RectangleCounter {
            ...
            for (Point b : possibleBs) {
                for (Point c : possibleCs) {
                    ...
                    if (points.contains(d)) {
                        if (hLine(grid, topLeft, b) && vLine(grid, topLeft, c) && vLine(grid, b, d) && hLine(grid, c, d)) {
    ...
    private boolean vLine(char[][] grid, Point min, Point max) {
    ...
    private boolean hLine(char[][] grid, Point min, Point max) {
